...
const gamePath = "/games/war-of-realms/index.html";
const thumbnailPath = "/games/war-of-realms/war_of_realms_thumbnail.png";
...
export default function WarOfRealmsPage() {
  return (
    <Container className="space-y-10 pb-4 md:space-y-12">
      ...
      <section className="gold-trim section-shell rounded-[2rem] [--trim-left:84%] [--trim-top:74%]">
        ...
        <div className="relative aspect-[16/9] w-full overflow-hidden rounded-b-[2rem] bg-black">
          <Image
            src={thumbnailPath}
            alt="War of Realms thumbnail preview"
            fill
            priority
